...
#define CALIBR_SAMPLES  500                       // ACS758 число усреднений при калибровке должно быть кратно 20
#define CURRENT_SAMPLES 80                        // ACS758 число усреднений при измернии должно быть кратно 20
